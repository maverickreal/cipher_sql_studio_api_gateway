...
import { requireAuthMware, requireAdminMware } from "../index";

describe("requireAuthMware", () => {
  ...
  it("should call next and attach user when session exists", async () => {
    ...
    await requireAuthMware(req as Request, res as Response, next);
...
describe("requireAdminMware", () => {
  ...
  it("should call next when user has admin role", async () => {
    ...
    await requireAdminMware(req as Request, res as Response, next);
